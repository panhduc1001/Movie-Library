...
public class Movie : IMovie
{
    ...
    {
        return string.Format("Movie title:{0} genre:{1} classification:{2} duration:{3} copies:{4}", this.Title, this.Genre, this.Classification, this.Duration, this.TotalCopies);
    }
}
